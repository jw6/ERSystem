...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		mc.hibernateReadExample();
		// hibernateReadAccount();
		// getVsLoad();
	}

	public void hibernateReadExample() {
		...
		Set<BankAccount> baSet = user.getBankAccount();

		// System.out.println(user.getBankAccount());
		for (BankAccount ba : baSet) {
			System.out.println(ba.getBankTx());
		}
	}
